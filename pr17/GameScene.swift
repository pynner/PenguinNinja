...
//  pr17
//
//  Created by Mitchell Pynn on 2017-01-02.
//  Copyright © 2017 Mitchell Pynn. All rights reserved.
//
    ...
    override func touchesMoved(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for node in nodesAtPoint {
            if node.name == "enemy" {
                ...
                let fadder = SKAction.fadeOut(withDuration: 0.2)
                let group = SKAction.group([fadder, scaleOut])
